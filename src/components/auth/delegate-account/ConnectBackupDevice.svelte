  ...
  >
    ...
    >
      ...
      <div class="flex justify-center space-x-2">
        <button
          class="mt-12 bg-violet-600 px-8  py-3 text-gray-50 hover:bg-violet-500"
          on:click={copyLink}
        >
          Share link
        </button>
        <button
          class="mt-12 bg-gray-200 px-8  py-3 text-gray-900 hover:bg-gray-100"
          on:click={skipBackup}
        >
          Skip
        </button>
    ...
    <img
      ...
      alt=""
      class="h-full bg-gray-500  object-cover xl:col-span-3"
    />
  </div>
</section>
