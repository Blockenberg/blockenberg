...
<section class="bg-gray-100 text-gray-800">
	<div class="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
		<h1 class="text-4xl font-bold leading-none sm:text-5xl">Welcome to BlockenBerg
			<span class="text-violet-600">headless and decentralized</span> CMS
		</h1>
		<p class="px-8 mt-8 mb-12 text-lg">We provide decentralized CMS for your website. All data stays yours, we provide just the tooling.</p>
		<div class="flex flex-wrap justify-center">
			<button class="px-8 py-3 m-2 text-lg font-semibold rounded bg-violet-600 text-gray-50">Get started</button>
			<button class="px-8 py-3 m-2 text-lg border rounded text-gray-900 border-gray-300">Learn more</button>
		</div>
	</div>
</section>
